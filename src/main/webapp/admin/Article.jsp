		...
		<nav class="side-navbar">
			<div class="side-navbar-wrapper">
				...
				<div class="sidenav-header d-flex align-items-center justify-content-center">
					<!-- User Info-->
					<div class="sidenav-header-inner text-center"><img src="../com/admin/img/avatar-2.jpg" alt="person" class="img-fluid rounded-circle">
				...
				<div class="main-menu">
					...
					<ul id="side-main-menu" class="side-menu list-unstyled">
						...
						<li class="active"><a href="Article.html">  <i class="fa fa-file-text"></i>文章管理</a></li>
					</ul>
				</div>
									...
									<div class="row">
										<div class="col-6">
											<div class="form-group row">
												<label class="col-sm-2 form-control-label m-auto text-right">板块</label>
												<div class="col-sm-10">
										...
										<div class="col-6">
											<div class="form-group row">
												<label class="col-sm-2 form-control-label m-auto text-right">搜索</label>
										...
										<table class="table table-striped">
											...
											<tbody>
												<tr>
													...
													<td>第一讲：习近平新时代中国特色社会主义思想是党和国家必须长期坚持的指导思想</td>
													<td>章航浦</td>
													<td>无</td>
													<td>2020.10.12 8:20</td>
													<td>2</td>
													<td>
